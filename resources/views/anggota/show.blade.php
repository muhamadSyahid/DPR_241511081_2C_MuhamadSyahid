    ...
    <div class="container mt-4">
        <div class="main-container">
            <div class="header-section text-center">
                ...
                <h1 class="h2 fw-bold mb-0">Detail Anggota DPR</h1>
                <p class="mb-0 opacity-75 small">Informasi lengkap anggota dewan</p>
            </div>
            ...
            <div class="p-3">
                ...
                <div class="d-flex gap-2 justify-content-end mt-3">
                    ...
                    @else
                        <span class="badge bg-secondary badge-sm py-1 px-2">
